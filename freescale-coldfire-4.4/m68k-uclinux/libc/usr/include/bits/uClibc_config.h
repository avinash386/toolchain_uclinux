...
#define __KERNEL_HEADERS__ "/scratch/maxim/fall-lite/install-uclinux/m68k-uclinux/libc/./usr/include"
...
#define __CROSS_COMPILER_PREFIX__ "/scratch/maxim/fall-lite/install-uclinux/bin/m68k-uclinux-"
